...
(function() {
  var camelcase, foundIds, foundIncludePaths, fs, furtherFilePaths, isComment, isInclude, log, olog, ostr, path, print, processFile, pughandlermodule, rememberFile, rememberId, scanLine;
