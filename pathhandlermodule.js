...
(function() {
  var cfg, checkDirectoryExists, checkFileExists, checkSomethingExists, exec, execGitCheckPromise, fs, glob, homedir, log, olog, os, ostr, pathModule, pathhandlermodule, print, resolveHomeDir;
